...
import Input from "@components/DynamicInput.astro";
...
# map the disk - need password
sudo cryptsetup lucksOpen /dev/sdX mapped

# mount the disk to mount point
sudo mount /dev/mapper/mapped DISK
```
