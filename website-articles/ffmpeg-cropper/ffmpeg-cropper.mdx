...
Introducing [ffmpeg-cropper](https://n4n5.dev/can-be-useful/html-ffmpeg-cropper/). Drag and drop your video and select the crop area. The tool will generate the ffmpeg filter for you (you can even play the video to check if the crop is correct).

Links:

- https://n4n5.dev/can-be-useful/html-ffmpeg-cropper/
- https://github.com/Its-Just-Nans/can-be-useful/tree/main/html-ffmpeg-cropper
