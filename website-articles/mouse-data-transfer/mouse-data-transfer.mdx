...
In this repository https://github.com/Its-Just-Nans/can-be-useful/tree/main/svelte-mouse-data-transfer, we explore the idea of using a mouse to transfer data between two devices. The concept is simple: use the mouse's movement to transfer data. The mouse is connected to a device, and the data is sent through the mouse's movement.

On our case our devices are: a phone and a desktop computer with a optical mouse. We place the mouse on the phone screen and start the web application https://n4n5.dev/can-be-useful/svelte-mouse-data-transfer/.
