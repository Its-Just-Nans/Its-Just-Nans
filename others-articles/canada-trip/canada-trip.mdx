...
import data from "@others-articles/assets/canada-trip/records.json"
...
Ate at the meat-lover's paradise [Ruben's](https://reubens.ca/)
...
import SherbrookeMap from "./sherbrooke.png"
import { Image } from 'astro:assets';

<details>
    <summary>Cool Sherbrooke Map, from tourist office:</summary>
    <Image src={SherbrookeMap} alt="Sherbrooke map"/>
</details>

---

import BixiData from "@others-articles/assets/canada-trip/bixi.json"
import AutoTable from "@components/AutoTable.astro"

<details>
<summary>Bixi (https://bixi.com/) data:</summary>
...
<Thought>
note: I should have used the monthly pass, I think it would have been cheaper.
</Thought>

<br/>

<AutoTable data={BixiData} />
